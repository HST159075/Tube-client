...
তোমার **Tube-server** backend-এর জন্য Next.js frontend।
...
## ⚠️ Backend-এ এই fix দরকার

তোমার `app.ts`-এ CORS-এ `localhost:3000` নেই, local dev-এ কাজ করবে না:
...
ফাইল: `BACKEND_FIX_app.ts` দেখো — সম্পূর্ণ fixed version আছে।
